...
const prepareCreateTableSQL = (databaseName) => {
  const fields = ['id VARCHAR(255) PRIMARY KEY', 'json json NOT NULL', 'seq INTEGER', 'deleted BOOLEAN NOT NULL', 'clusterid VARCHAR(255) NOT NULL']
  for (let i = 1; i <= defaults.indexes; i++) {
